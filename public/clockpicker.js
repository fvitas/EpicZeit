...
;(function () {
  ...
  function raiseCallback(callbackFunction, ...args) {
  ...
  ClockPicker.prototype.toggleView = function (view, delay) {
    ...
    if (raiseAfterHourSelect) {
      raiseCallback(this.options.afterHourSelect, this.spanHours.text(), this.spanMinutes.text(), this.spanAmPm.text())
    }
  }
  ...
  ClockPicker.prototype.setHand = function (x, y, roundBy5, dragging) {
    ...
    raiseCallback(this.options.onChange, this.spanHours.text(), this.spanMinutes.text(), this.spanAmPm.text())
  }
  ...
  ClockPicker.prototype.done = function () {
    ...
    raiseCallback(this.options.afterDone, this.spanHours.text(), this.spanMinutes.text(), this.spanAmPm.text())
  }
